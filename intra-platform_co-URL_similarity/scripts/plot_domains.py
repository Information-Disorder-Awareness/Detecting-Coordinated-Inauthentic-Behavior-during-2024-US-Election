...
def plot_domain_counts(platform: Platform):
    # Read and prepare data
    df = pd.read_csv(f"../datasets/{platform}/domain_occurrences.csv", names=['domain', 'count'])[1:]
    ...
    # Save and show
    plt.savefig(f"../networks/{platform}/output/domain_plot.png", dpi=300, bbox_inches='tight')
